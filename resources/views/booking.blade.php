        ...
        <div class="booking-card">
            ...
            <form action="{{ route('booking.store') }}" method="POST" class="booking-form">
                ...
                <div class="field-group">
                    ...
                    <input type="text" id="no_wa" name="no_wa" placeholder="Nomor WhatsApp" value="{{ old('no_wa') }}"
                        required>
                </div>
                <div class="field-group time">
                ...
                <div class="field-group lokasi">
                    ...
                    <select id="tipe" name="tipe" required>
                        <option value="indoor" {{ old('tipe')==='indoor' ? 'selected' : '' }}>Indoor (Photo Studio)
                        </option>
                ...
                <div class="field-group full">
                    ...
                    <textarea id="note" name="note"
                        placeholder="Contoh: Tema pastel, bawa properti sendiri, dll">{{ old('note') }}</textarea>
                </div>
