...
<section class="galeri-detail">
  <div class="container">
    <h1>Galeri Foto couple</h1>
    <p class="subtitle">Koleksi foto-foto Couple terbaik dari Vanillablue Photostudio</p>

    <div class="grid-galeri">
      <img src="assets/images/couple/couple1.jpg" alt="Couple 1">
      <img src="assets/images/couple/couple2.jpg" alt="Couple 2">
      <img src="assets/images/couple/couple3.jpg" alt="Couple 3">
      <img src="assets/images/couple/couple4.jpg" alt="Couple 4">
      <img src="assets/images/couple/couple5.jpg" alt="Couple 5">
    </div>
...
<section class="harga-section">
  <h2>List Harga Foto Couple</h2>

  <div class="harga-list">
    <div class="harga-card">
      <p class="kategori">COUPLE</p>
      <ul>
        <li>15 menit</li>
