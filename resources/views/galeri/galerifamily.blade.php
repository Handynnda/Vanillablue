...
<section class="galeri-detail">
  <div class="container">
    ...
    <p class="subtitle">Koleksi foto-foto Family terbaik dari Vanillablue Photostudio</p>

    <div class="grid-galeri">
      <img src="assets/images/family/family1.jpg" alt="Family 1">
      <img src="assets/images/family/family2.jpg" alt="Family 2">
      <img src="assets/images/family/family3.jpg" alt="Family 3">
      <img src="assets/images/family/family4.jpg" alt="Family 4">
      <img src="assets/images/family/family5.jpg" alt="Family 5">
    </div>
...
<section class="harga-section">
  <h2>List Harga Foto Family</h2>

  <div class="harga-list">
    <div class="harga-card">
      <p class="kategori">FAMILY A</p>
      <ul>
        <li>15 menit</li>
    ...
    <div class="harga-card">
      ...
      <p class="harga">IDR 400.000</p>
      <a href="booking.php" class="btn-booking">BOOKING</a>
    </div>

    <div class="harga-card">
      <p class="kategori">FAMILY C</p>
      <ul>
        <li>15 menit</li>
        <li>All file google drive</li>
        <li>10 edit</li>
