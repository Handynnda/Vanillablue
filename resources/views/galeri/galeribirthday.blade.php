...
<section class="galeri-detail">
  <div class="container">
    <h1>Galeri Foto Birthday</h1>
    <p class="subtitle">Koleksi foto-foto Birthday terbaik dari Vanillablue Photostudio</p>
    ...
    <div class="grid-galeri">
      ...
      <img src="assets/images/birthday/birthday4.jpg" alt="Birthday 4">
      <img src="assets/images/birthday/birthday5.jpg" alt="Birthday 5">
      <img src="assets/images/birthday/birthday6.jpg" alt="Birthday 6">
    </div>
...
<section class="harga-section">
  <h2>List Harga Foto Birthday</h2>

  <div class="harga-list">
    <div class="harga-card">
      <p class="kategori">BIRTHDAY</p>
      <ul>
        <li>20 menit</li>
        <li>All file google drive</li>
      </ul>
      <p class="harga">IDR 300.000</p>
